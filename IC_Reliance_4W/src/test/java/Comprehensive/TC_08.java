...
public class TC_08 extends Launch_browser01

	{
	    ...
	    {
           System.out.println("TP popup only present for SAOD");
	    }
	    ...
	    public void reg_date()
	    {
	    	...
	    	expiry_year.selectByVisibleText("2015");
	    ...
	    public void Previous_Expirydate()
	    {
	    ...
	    @Test(priority = 13, dependsOnMethods = "Previous_Expirydate")
	    ...
	    public void ncb_drpdwn ()
	    {
	        ...
	        ncb_percent.selectByVisibleText("45%");
	    }
...
//	    }
	    ...
	    
	    {
	    	...
	    	By vol_drpdwn = By.xpath("//select[@id='voluntdect']");
	    	util.waitForElement(vol_drpdwn);
	    	Select vol_drp = new Select(driver.findElement(vol_drpdwn));
	    	vol_drp.selectByVisibleText("7500");
