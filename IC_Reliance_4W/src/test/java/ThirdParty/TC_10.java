...
public class TC_10  extends Launch_browser01{
...
//		    
		    ...
		    @Test(priority = 4, dependsOnMethods = "Third_party", dataProvider = "rtoData")
		    ...
		    @Test(priority = 15, dependsOnMethods = "CPA_Yes")
		    public void ownership_no ()
		    {
		    	System.out.println("ownership doesnot allowed");
...
//		        driver.findElement(owner).click();
		    ...
		    {
		    	System.out.println("Claim doesnot allowed");
