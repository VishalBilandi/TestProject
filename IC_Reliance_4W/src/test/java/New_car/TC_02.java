//1.Individual
//2.With CPA
//3.With Add ons, accessories cover, PA cover, discount, CNG
//4.With finance
...
public class TC_02 extends Launch_browser01 {
    ...
    public void CPA_yes () 
    {
        By cpa = By.xpath("/html[1]/body[1]/div[4]/div[1]/div[1]/div[2]/section[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[6]/div[1]/div[1]");
    ...
    @Test(priority = 7, dependsOnMethods = "CPA_yes", dataProvider = "fullname")
  ...
  @Test(priority = 8, dependsOnMethods = "fullname", dataProvider = "Mobilenum")
  ...
  @Test(priority = 9, dependsOnMethods = "mobnum")
  ...
  @Test(priority = 10, dependsOnMethods = "term_con")
  public void quote_btn() {
    ...
    @Test(priority = 11, dependsOnMethods = "quote_btn")
...
//      By open_drpdwn = By.id("addons_drpdown");
    ...
    @Test(priority = 12, dependsOnMethods = "addons_drpdown")
    ...
    @Test(priority = 13, dependsOnMethods = "addons_select")
    ...
    @Test(priority = 14, dependsOnMethods = "claimfor_zerodep")
    ...
    @Test(priority = 15, dependsOnMethods = "zrodep_btn")
...
//            WebElement element = driver.findElement(locator);
    ...
    @Test(priority = 16, dependsOnMethods = "all_addons")
    ...
    @Test(priority = 17, dependsOnMethods = "Accessrios_cover", dataProvider= "electric")
    ...
    @Test(priority = 18, dependsOnMethods = "elec_acc", dataProvider= "non_electric")
    ...
    @Test(priority = 19, dependsOnMethods = "non_elec")
    ...
    @Test(priority = 20, dependsOnMethods = "pa_cover")
    ...
    @Test(priority = 21, dependsOnMethods = "discounts", dataProvider = "cng_value")
  ...
  @Test(priority = 22, dependsOnMethods = "cng")
  public void getquote () {
    ...
    @Test(priority = 23, dependsOnMethods = "getquote")
    ...
    @Test(priority = 24, dependsOnMethods = "ckyc_yes", dataProvider = "ckyc_number")
    ...
    @Test(priority = 25, dependsOnMethods = "ckyc_number")
    ...
    @Test(priority = 26, dependsOnMethods = "dob_calender", dataProvider = "enter_email" )
    ...
    @Test(priority = 27, dependsOnMethods = "email")
    ...
    @Test(priority = 28, dependsOnMethods = "Verify_kyc")
    ...
    @Test(priority = 29, dependsOnMethods = "Marital", dataProvider = "pancard")
    ...
    @Test(priority = 30, dependsOnMethods = "pan")
	...
	
	{
	 ...
	 @Test(priority = 39, dependsOnMethods = "engine", dataProvider = "chasis")
	...
	
	{
	 ...
	 @Test(priority = 40, dependsOnMethods = "chasis", dataProvider = "reg_code")
	 ...
	 @Test(priority = 41, dependsOnMethods = "reg_code", dataProvider = "reg_num")
	 ...
	 @Test(priority = 42, dependsOnMethods = "reg_num")
	...
	
	{
	 ...
	 @Test(priority = 43, dependsOnMethods = "loan_yes")
	...
	
	{
	 ...
	 @Test(priority = 44, dependsOnMethods = "bnk_name")
	...
	
	{
	 ...
	 @Test(priority = 45, dependsOnMethods = "bnk_city")
	...
	
	{
		...
		@Test(priority = 46, dependsOnMethods = "vehicle_button")
		public void terms()
		...
		@Test(priority = 47, dependsOnMethods = "terms")
		...
		@Test(priority = 48, dependsOnMethods = "existing_cust")
		...
		@Test(priority = 49, dependsOnMethods = "Make_payment")
		...
		@Test(priority = 50, dependsOnMethods = "Make_payment_rel")
	...
	@Test(priority = 51, dependsOnMethods = "net_banking")
	...
	@Test(priority = 52, dependsOnMethods = "select_bank")    //submit net banking
	...
	@Test(priority = 53, dependsOnMethods = "Rel_payment")  //success response
	...
	@Test(priority = 54, dependsOnMethods = "success_payment")      //policy number
