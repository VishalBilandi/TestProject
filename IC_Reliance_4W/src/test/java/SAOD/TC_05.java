...
//4.With finance
	...
	public class TC_05 extends Launch_browser01
	{
	    ...
	    public void standalone_OD() throws InterruptedException
	    {
	        By Saod = By.xpath("//div[@id='StandaloneODP']");
	        util.waitForElement(Saod);
	        driver.findElement(Saod).click();
	    }
	    
	    
	    @Test(priority = 3, dependsOnMethods = "standalone_OD")
...
//	    }
	  ...
	  public void premium()
	  {
	      By pre_btn = By.xpath("//button[@id='buy_RelianceODOnly']");
	    ...
	    @Test(priority = 34, dependsOnMethods = "kyc_button", dataProvider = "ckyc_number")
	    ...
	    @Test(priority = 38, dependsOnMethods = "Verify_kyc")
	    ...
	    @Test(priority = 39, dependsOnMethods = "Marital", dataProvider = "pancard")
	    ...
	    @Test(priority = 40, dependsOnMethods = "pan", dataProvider = "email_reset")
	    ...
	    @Test(priority = 41, dependsOnMethods = "email_reset")
	    ...
	    @Test(priority = 42, dependsOnMethods = "insureddetails_btn", dataProvider = "pincode")
...

	    {
		 ...
		 @Test(priority = 49, dependsOnMethods = "nominee_btn", dataProvider = "engine")
		...
		
		{
		 ...
		 @Test(priority = 50, dependsOnMethods = "engine", dataProvider = "engine")
		...
		
		{
		 ...
		 @Test(priority = 51, dependsOnMethods = "chasis")
			...
			
			{
			 ...
			 @Test(priority = 52, dependsOnMethods = "loan_yes")
			...
			
			{
			 ...
			 @Test(priority = 53, dependsOnMethods = "bnk_name")
		 ...
		 @Test(priority = 54, dependsOnMethods = "bnk_city")
		...
		@Test(priority = 55 , dependsOnMethods = "vehicle_button")
		...
		
		{
		    ...
		    By existing_tp = By.xpath("//select[@id='TPPrevious_Insurer']");
		    Select tp_drpdwn = new Select(driver.findElement(existing_tp));
		    tp_drpdwn.selectByVisibleText("Cholamandalam MS General Insurance");
		    
			By tp_no = By.xpath("//input[@id='Tp_Policy_no']");
			driver.findElement(tp_no).click();
			driver.findElement(tp_no).sendKeys("p675ghfrr5556756");
			...
			@Test(priority = 56, dependsOnMethods = "previous_policy")
			public void terms()
			...
			@Test(priority = 57, dependsOnMethods = "terms")
			...
			@Test(priority = 58, dependsOnMethods = "existing_cust")
			...
			@Test(priority = 59, dependsOnMethods = "Make_payment")
			...
			@Test(priority = 60, dependsOnMethods = "Make_payment_rel")
		...
		@Test(priority = 61, dependsOnMethods = "net_banking")
		...
		@Test(priority = 62, dependsOnMethods = "select_bank")    //submit net banking
		...
		@Test(priority = 63, dependsOnMethods = "Rel_payment")  //success response
		...
		@Test(priority = 64, dependsOnMethods = "success_payment")      //policy number
