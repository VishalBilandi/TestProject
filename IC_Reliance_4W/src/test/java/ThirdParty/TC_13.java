...
public class TC_13 extends Launch_browser01

{
		    ...
		    public void Third_party() throws InterruptedException
		    {
		        By TP = By.xpath("//div[@id='ThirdPartyP']");
		        util.waitForElement(TP);
		        driver.findElement(TP).click();
		    }
		    
		    
		    
		    @Test(priority = 3, dependsOnMethods = "Third_party")
...
//		    	driver.findElement(popup_okbtn).click();
		    ...
		    public void reg_date()
		    {
		    	...
		    	expiry_year.selectByVisibleText("2012");
		    ...
		    public void previous_pol()
		    {
		    	...
		    	drpdwn.selectByVisibleText("Expired more than 90 days");
		    }
		    
		    @Test(priority = 11, dependsOnMethods = "previous_pol")
		    public void previouscopy_Yes()
		    {
		    	By pre_copy = By.xpath("/html[1]/body[1]/div[4]/div[1]/div[1]/div[2]/section[1]/div[2]/div[1]/form[1]/div[2]/div[1]/div[1]/div[9]/div[1]/div[1]");
		    	util.waitForElement(pre_copy);
		    	driver.findElement(pre_copy).click();
		    	
		    	
		    }
		    

		    @Test(priority = 12, dependsOnMethods = "previouscopy_Yes")
		    public void pol_Expirydate()
		    {
		    	...
		    	expiry_year.selectByVisibleText("2024");
		       	...
		       	By month = By.xpath("//select[@aria-label='Select month']");
		    	Select expiry_month = new Select(driver.findElement(month));
		    	expiry_month.selectByVisibleText("Feb");
		    ...
		    @Test(priority = 13, dependsOnMethods = "pol_Expirydate")
		    ...
		    public void CPA_No()
		    {
		        ...
		        By cpa = By.xpath("/html[1]/body[1]/div[4]/div[1]/div[1]/div[2]/section[1]/div[2]/div[1]/form[1]/div[2]/div[1]/div[1]/div[13]/div[1]/div[2]");
//		        js.executeScript("arguments[0].scrollIntoView(false);", driver.findElement(cpa));
...
//		        ncb_percent.selectByVisibleText("20%");
		  ...
		  public void fullname(String fn)
		  {
		      ...
		      js.executeScript("arguments[0].scrollIntoView(false);", driver.findElement(fullNameLocator));
		  ...
		  public void get_quote()
		  {
		    ...
		    @Test(priority = 22, dependsOnMethods = "pa_cover", dataProvider = "cng_value")
		  ...
		  public void premium()
		  {
		      By pre_btn = By.xpath("//button[@id='buy_RelianceTP']");
...
//		      driver.findElement(confirm_btn).click();
		    ...
		    @Test(priority = 24, dependsOnMethods = "premium")
		    ...
		    @Test(priority = 25, dependsOnMethods = "kyc_button", dataProvider = "ckyc_number")
		    ...
		    @Test(priority = 27, dependsOnMethods = "ckyc_number")
		    ...
		    @Test(priority = 28, dependsOnMethods = "dob_calender", dataProvider = "enter_email" )
		    ...
		    @Test(priority = 29, dependsOnMethods = "email")
		    ...
		    @Test(priority = 30, dependsOnMethods = "Verify_kyc")
		    ...
		    @Test(priority = 31, dependsOnMethods = "Marital", dataProvider = "pancard")
		    ...
		    @Test(priority = 32, dependsOnMethods = "pan", dataProvider = "email_reset")
		    ...
		    @Test(priority = 33, dependsOnMethods = "email_reset")
		    ...
		    @Test(priority = 34, dependsOnMethods = "insureddetails_btn", dataProvider = "pincode")
		    ...
		    @Test(priority = 35, dependsOnMethods = "address")
		    ...
		    @Test(priority = 36, dependsOnMethods = "current_address")
		    ...
		    @Test(priority = 37, dependsOnMethods = "address_btn", dataProvider = "nominee")
		    ...
		    @Test(priority = 38, dependsOnMethods = "nomin_name")
		    ...
		    @Test(priority = 39, dependsOnMethods = "nominee_marital")
		    ...
		    @Test(priority = 40, dependsOnMethods = "nominee_dob")
...

		    {
			 ...
			 @Test(priority = 41, dependsOnMethods = "nominee_btn", dataProvider = "engine")
			...
			
			{
			 ...
			 @Test(priority = 42, dependsOnMethods = "engine", dataProvider = "engine")
			...
			
			{
			 ...
			 @Test(priority = 43, dependsOnMethods = "chasis")
				...
				
				{
				 ...
				 @Test(priority = 44, dependsOnMethods = "loan_yes")
				...
				
				{
				 ...
				 @Test(priority = 45, dependsOnMethods = "bnk_name")
			 ...
			 @Test(priority = 46, dependsOnMethods = "bnk_city")
			...
			@Test(priority = 47 , dependsOnMethods = "vehicle_button")
			...
			
			{
			    ...
			    policy_drpdwn.selectByVisibleText("Third Party Liability");

			    
				By nxt_btn = By.xpath("//button[@ng-click=\"PrePolicyDetailsFormSubmit('ConfirmDetails');\"]");
				driver.findElement(nxt_btn).click();
				
			} 
			 

				@Test(priority = 48, dependsOnMethods = "previous_policy")
				public void terms()
				...
				@Test(priority = 49, dependsOnMethods = "terms")
				...
				@Test(priority = 50, dependsOnMethods = "existing_cust")
				...
				@Test(priority = 51, dependsOnMethods = "Make_payment")
				...
				@Test(priority = 52, dependsOnMethods = "Make_payment_rel")
			...
			@Test(priority = 53, dependsOnMethods = "net_banking")
			...
			@Test(priority = 54, dependsOnMethods = "select_bank")    //submit net banking
			...
			@Test(priority = 55, dependsOnMethods = "Rel_payment")  //success response
			...
			@Test(priority = 56, dependsOnMethods = "success_payment")      //policy number
