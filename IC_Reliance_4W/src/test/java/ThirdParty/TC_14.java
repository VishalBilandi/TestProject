...
public class TC_14 extends Launch_browser01 {
	    ...
	    @Test(priority = 3, dependsOnMethods = "TP")
...
//	    	driver.findElement(popup_okbtn).click();
	    ...
	    public void owner_type () 
	    {
	        ...
	        By org_popup = By.xpath("/html[1]/body[1]/div[4]/div[1]/div[1]/div[2]/section[1]/div[5]/div[1]/div[1]/div[2]/button[1]");
	        util.waitForElement(org_popup);
	        driver.findElement(org_popup).click();
